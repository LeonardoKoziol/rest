...
<body>
 ...
 <form action="adm2.php" class="form-horizontal" method="POST" id="usuario_cadastro" name="usuario_cadastro"></form>
	<fieldset>
<!-- Text input-->
<div class="form-group">
  <label class="col-md-4 control-label" for="txtnome">Nome</label>  
  <div class="col-md-5">
  <input id="txtnome" name="Nome" maxlength="50" type="text" placeholder="" class="form-control input-md" required="">
...
<div class="form-group">
  ...
  <div class="col-md-5">
  <input id="txtnome" name="senha" maxlength="50" type="text" placeholder="" class="form-control input-md" required="">
...
<div class="form-group">
  ...
  <div class="col-md-5">
  <input id="txtdata" name="data"  type="date" placeholder="" class="form-control input-md" required="">
...
<div class="form-group">
  ...
  <div class="col-md-5">
  <input id="txtemail" name="email" type="email" maxlength="30" placeholder="" class="form-control input-md" required="">
...
<div class="form-group">
  ...
  <div class="radio">
    <label for="radsexo-0">
      <input type="radio" name="sexo" id="radsexo-0" value="M" >
      Masculino
    </label>
  </div>
  <div class="radio">
    <label for="radsexo-1">
      <input type="radio" name="sexo" id="radsexo-1" value="F">
      Feminino
    </label>
  </div>
  </div>
...
<div class="form-group">
  ...
  <div class="radio">
    <label for="radtipo-0">
      <input type="radio" name="tipo" id="radtipo-0" value="ADM" >
      Administrador
    </label>
  </div>
  <div class="radio">
    <label for="radtipo-1">
      <input type="radio" name="tipo" id="radtipo-1" value="COM">
      Comum
    </label>
  </div>
  </div>
...
<div class="form-group">
  ...
  <div class="col-md-4">
    ...
    <button id="btnalterar" name="btalterar" class="btn btn-success"><a href="alterar.php">Alterar</a></button>
